...
INSERT INTO Questions (sortOrder, question, isValid, answer)
SELECT t.*
FROM (
  SELECT 10 AS sortOrder, 'How many students are there in total?' AS question, TRUE AS isValid, NULL AS answer
  UNION ALL SELECT 20, 'What''s the earliest birth date in the database?', TRUE, NULL
  UNION ALL SELECT 30, 'How many students have the last name "Mouse"?', TRUE, NULL
  UNION ALL SELECT 40, 'Which students don''t have a last name?', TRUE, NULL
  UNION ALL SELECT 50, 'How many students live in California?', TRUE, NULL
  UNION ALL SELECT 60, 'Who are all the students from the Simpson family?', TRUE, NULL
  UNION ALL SELECT 70, 'Which students share the same birth date?', TRUE, NULL
  UNION ALL SELECT 80, 'How many different states are represented in the addresses?', TRUE, NULL
  UNION ALL SELECT 90, 'Who has the most recent birth date?', TRUE, NULL
  UNION ALL SELECT 100, 'How many students have a "Parent" relationship listed?', TRUE, NULL
  UNION ALL SELECT 110, 'Which email domains are most common?', TRUE, NULL
  UNION ALL SELECT 120, 'How many students live at the same address?', TRUE, NULL
  UNION ALL SELECT 130, 'Who are all the students from Bikini Bottom?', TRUE, NULL
  UNION ALL SELECT 140, 'Which students were active in 2005?', TRUE, NULL
  UNION ALL SELECT 150, 'How many different area codes are there?', TRUE, NULL
  UNION ALL SELECT 160, 'Which students have multiple years listed?', TRUE, NULL
  UNION ALL SELECT 170, 'Who are the oldest students based on birth date?', TRUE, NULL
  UNION ALL SELECT 180, 'How many students have a "Friend" relationship?', TRUE, NULL
  UNION ALL SELECT 190, 'Which cities have the most students?', TRUE, NULL
  UNION ALL SELECT 200, 'How many students have the same first name?', TRUE, NULL
  UNION ALL SELECT 210, 'Who lives at "31 Spooner St"?', TRUE, NULL
  UNION ALL SELECT 220, 'Which students are from Warner Bros Studios?', TRUE, NULL
  UNION ALL SELECT 230, 'How many students don''t have an email address?', TRUE, NULL
  UNION ALL SELECT 240, 'Which year has the most active students?', TRUE, NULL
  UNION ALL SELECT 250, 'How many students live in fictional cities?', TRUE, NULL
  UNION ALL SELECT 260, 'Who are all the Duck family members?', TRUE, NULL
  UNION ALL SELECT 270, 'Which students share the same contact name?', TRUE, NULL
  UNION ALL SELECT 280, 'How many different zip codes are there?', TRUE, NULL
  UNION ALL SELECT 290, 'Who has the longest email address?', TRUE, NULL
  UNION ALL SELECT 300, 'Which students are from the same family?', TRUE, NULL
  UNION ALL SELECT 310, 'How many students have a NULL birth date?', TRUE, NULL
  UNION ALL SELECT 320, 'Which students live and receive mail at the same address?', TRUE, NULL
  UNION ALL SELECT 330, 'Who has the earliest year ID?', TRUE, NULL
  UNION ALL SELECT 340, 'How many different streets are there?', TRUE, NULL
  UNION ALL SELECT 350, 'Which students are from Disney properties?', TRUE, NULL
  UNION ALL SELECT 360, 'How many students have the same phone number?', TRUE, NULL
  UNION ALL SELECT 370, 'Who are all the Griffin family members?', TRUE, NULL
  UNION ALL SELECT 380, 'Which students don''t have a state listed?', TRUE, NULL
  UNION ALL SELECT 390, 'How many students were born in the 1920s?', TRUE, NULL
  UNION ALL SELECT 400, 'Which students have multiple active years?', TRUE, NULL
  UNION ALL SELECT 410, 'Who are all the students from South Park?', TRUE, NULL
  UNION ALL SELECT 420, 'How many different relationships are listed?', TRUE, NULL
  UNION ALL SELECT 430, 'Which students share the same contact information?', TRUE, NULL
  UNION ALL SELECT 440, 'How many students were born on the same day?', TRUE, NULL
  UNION ALL SELECT 450, 'Who has the most recent year ID?', TRUE, NULL
  UNION ALL SELECT 460, 'Which students have incomplete address information?', TRUE, NULL
  UNION ALL SELECT 470, 'How many students are from each decade?', TRUE, NULL
  UNION ALL SELECT 480, 'Who are all the students from Bedrock?', TRUE, NULL
  UNION ALL SELECT 490, 'Which students have matching first and last names?', TRUE, NULL
  UNION ALL SELECT 500, 'How many different contact names are there?', TRUE, NULL
  UNION ALL SELECT 510, 'Who are the students from Orbit City?', TRUE, NULL
  UNION ALL SELECT 520, 'Which students have the same area code?', TRUE, NULL
  UNION ALL SELECT 530, 'How many students don''t have a phone number?', TRUE, NULL
  UNION ALL SELECT 540, 'Who are all the students born in 1999?', TRUE, NULL
  UNION ALL SELECT 550, 'Which addresses have multiple students?', TRUE, NULL
  UNION ALL SELECT 560, 'How many students are from each state?', TRUE, NULL
  UNION ALL SELECT 570, 'Who are the students from Far Far Away?', TRUE, NULL
  UNION ALL SELECT 580, 'Which students have matching email domains?', TRUE, NULL
  UNION ALL SELECT 590, 'How many students have a "Pet" relationship?', TRUE, NULL
  UNION ALL SELECT 600, 'Who has the longest street name?', TRUE, NULL
  UNION ALL SELECT 610, 'Which students share birth years?', TRUE, NULL
  UNION ALL SELECT 620, 'How many different cities are represented?', TRUE, NULL
  UNION ALL SELECT 630, 'Who are all the students without states?', TRUE, NULL
  UNION ALL SELECT 640, 'Which year has the least active students?', TRUE, NULL
  UNION ALL SELECT 650, 'How many students have matching contact names?', TRUE, NULL
  UNION ALL SELECT 660, 'Who are the students from Mystery Inc?', TRUE, NULL
  UNION ALL SELECT 670, 'Which students have the same zip code?', TRUE, NULL
  UNION ALL SELECT 680, 'How many students were active in multiple years?', TRUE, NULL
  UNION ALL SELECT 690, 'Who has the shortest email address?', TRUE, NULL
  UNION ALL SELECT 700, 'Which students live at the same number?', TRUE, NULL
  UNION ALL SELECT 710, 'How many different contact relationships exist?', TRUE, NULL
  UNION ALL SELECT 720, 'Who are all the students from Quahog?', TRUE, NULL
  UNION ALL SELECT 730, 'Which students have matching phone numbers?', TRUE, NULL
  UNION ALL SELECT 740, 'How many students don''t have an active year?', TRUE, NULL
  UNION ALL SELECT 750, 'Who shares the same contact information?', TRUE, NULL
  UNION ALL SELECT 760, 'Which students have the same birth month?', TRUE, NULL
  UNION ALL SELECT 770, 'How many different email domains exist?', TRUE, NULL
  UNION ALL SELECT 780, 'Who are all the students from Sweethaven?', TRUE, NULL
  UNION ALL SELECT 790, 'Which addresses have the same zip code?', TRUE, NULL
  UNION ALL SELECT 800, 'How many students have matching area codes?', TRUE, NULL
  UNION ALL SELECT 810, 'Who are the students without email addresses?', TRUE, NULL
  UNION ALL SELECT 820, 'Which students have the same contact relationship?', TRUE, NULL
  UNION ALL SELECT 830, 'How many different street numbers exist?', TRUE, NULL
  UNION ALL SELECT 840, 'Who are all the students from Springfield?', TRUE, NULL
  UNION ALL SELECT 850, 'Which students share the same year ID?', TRUE, NULL
  UNION ALL SELECT 860, 'How many students have incomplete contact info?', TRUE, NULL
  UNION ALL SELECT 870, 'Who has the most common birth year?', TRUE, NULL
  UNION ALL SELECT 880, 'Which students have matching city names?', TRUE, NULL
  UNION ALL SELECT 890, 'How many different birth dates exist?', TRUE, NULL
  UNION ALL SELECT 900, 'Who are the students from Mouseville?', TRUE, NULL
  UNION ALL SELECT 910, 'Which addresses have the same state?', TRUE, NULL
  UNION ALL SELECT 920, 'How many students have matching street names?', TRUE, NULL
  UNION ALL SELECT 930, 'Who has the most recent active year?', TRUE, NULL
  UNION ALL SELECT 940, 'Which students share contact names?', TRUE, NULL
  UNION ALL SELECT 950, 'How many different relationships per city?', TRUE, NULL
  UNION ALL SELECT 960, 'Who are all the students without birth dates?', TRUE, NULL
  UNION ALL SELECT 970, 'Which years have the most student activity?', TRUE, NULL
  UNION ALL SELECT 980, 'How many students share email domains?', TRUE, NULL
  UNION ALL SELECT 990, 'Who has multiple entries in StudentYear?', TRUE, NULL
  UNION ALL SELECT 1000, 'Which students have the same contact relationship and city?', TRUE, NULL
) t
